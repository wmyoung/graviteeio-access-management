...
public class ApplicationResourceResource extends AbstractResource {
    ...
    @ApiResponses({
            @ApiResponse(code = 200, message = "List resource set for an application", response = ResourceSet.class),
    ...
    public void get(
        ...
        checkAnyPermission(organizationId, environmentId, domain, application, Permission.APPLICATION_RESOURCE, Acl.READ)
                .andThen(domainService.findById(domain)
                        ...
                        .flatMap(application1 -> resourceSetService.findByDomainAndClientResource(domain, application1.getId(), resource)))
